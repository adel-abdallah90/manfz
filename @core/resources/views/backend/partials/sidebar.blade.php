...
{{--                                @endcan--}}
                               ...
                               @can('order-create-setting')
                                    <li class="{{ active_menu('admin-home/services/load-more-category-settings') }}"><a
                                      href="{{ route('admin.service.load.more.category.settings') }}">{{ __('Load More Settings') }}</a></li>
                                @endcan

                                @can('order-create-setting')
                                    <!--service zone set -->
                                    {{--  <li class="{{ active_menu('admin-home/zone/create') }}"><a  href="{{ route('admin.service.zone') }}">{{ __('Service Zone Add') }}</a></li>--}}
                                   <li class="{{ active_menu('admin-home/services/zones-settings') }}"><a  href="{{ route('admin.service.zone.settings') }}">{{ __('Google Map Settings') }}</a></li>
                                @endcan
