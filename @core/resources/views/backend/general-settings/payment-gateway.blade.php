                                            ...
                                            <div class="card">
                                                ...
                                                <div id="kineticpay_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="kineticpay_gateway"><strong>{{__('Enable/Disable Kineticpay')}}</strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="kineticpay_gateway"  @if(!empty(get_static_option('kineticpay_gateway'))) checked @endif >
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="kineticpay_test_mode"><strong>{{__('Enable Test Mode Kineticpay')}}</strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="kineticpay_test_mode" @if(!empty(get_static_option('kineticpay_test_mode'))) checked @endif>
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="kineticpay_preview_logo"><strong>{{__('Kineticpay Logo')}}</strong></label>
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    @php
                                                                ...
                                                                <input type="hidden" name="kineticpay_preview_logo" value="{{get_static_option('kineticpay_preview_logo')}}">
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="{{__('Select Image')}}" data-modaltitle="{{__('Upload Image')}}" data-toggle="modal" data-target="#media_upload_modal">
                                                                    {{__($mollie_image_btn_label)}}
                                                                </button>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="kineticpay_username">{{__('Kineticpay Username')}}</label>
                                                            <input type="text" name="kineticpay_username"  value="{{get_static_option('kineticpay_username')}}" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
