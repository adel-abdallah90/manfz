...
<div class="page-container">
    ...
    <footer>
        <div class="footer-area footer-wrap">
            ...
            <p class="version">V-<?php echo e(get_static_option('site_script_version','1.4.4')); ?></p>
        </div>
    </footer>
</div>
...
<?php /**PATH /home/halwanimadani/manfz/@core/resources/views/backend/admin-master.blade.php ENDPATH**/ ?>