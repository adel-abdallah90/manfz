...
<?php $__env->startSection('page-meta-data'); ?>
  <title> <?php echo e(__('Popular Services')); ?></title>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-title'); ?>
<?php echo e(__('Popular Service')); ?>

<?php $__env->stopSection(); ?> 

<?php $__env->startSection('inner-title'); ?>
<?php echo e(__('All Popular Service')); ?>
    ...
    <section class="category-services-area padding-top-70 padding-bottom-100">
        <div class="container">
            <div class="row">
                ...
                <?php if(!empty($all_popular_service)): ?>
                    <?php $__currentLoopData = $all_popular_service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($all_popular_service->count() >= 9): ?>
                        <div class="col-lg-12">
                            <div class="blog-pagination margin-top-55">
                                <div class="custom-pagination mt-4 mt-lg-5">
                                    <?php echo $all_popular_service->links(); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/manfz/ssll/manfz.sa/@core/resources/views/frontend/pages/services/popular-service.blade.php ENDPATH**/ ?>