...
} elseif ($_instance->childHasBeenRendered('r2dcWIe')) {
    $componentId = $_instance->getRenderedChildComponentId('r2dcWIe');
    $componentTag = $_instance->getRenderedChildComponentTagName('r2dcWIe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('r2dcWIe');
} else {
    $response = \Livewire\Livewire::mount('edit-service', ['editServiceId' => $edit_service_id,'edit_service_id' => $edit_service_id]);
    $html = $response->html();
    $_instance->logRenderedChild('r2dcWIe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/manfz/ssll/manfz.sa/@core/resources/views/frontend/user/seller/services/partials/edit-service-two.blade.php ENDPATH**/ ?>