...
} elseif ($_instance->childHasBeenRendered('HqYd4bu')) {
    $componentId = $_instance->getRenderedChildComponentId('HqYd4bu');
    $componentTag = $_instance->getRenderedChildComponentTagName('HqYd4bu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HqYd4bu');
} else {
    $response = \Livewire\Livewire::mount('add-service', []);
    $html = $response->html();
    $_instance->logRenderedChild('HqYd4bu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/manfz/ssll/manfz.sa/@core/resources/views/frontend/user/seller/services/partials/add-service-two.blade.php ENDPATH**/ ?>