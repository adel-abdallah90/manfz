                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.basic.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="disable_user_otp_verify"><strong><?php echo e(__('User OTP Verify')); ?></strong></label>
                                <label class="switch">
                                    <input type="checkbox" name="disable_user_otp_verify"  <?php if(!empty(get_static_option('disable_user_otp_verify'))): ?> checked <?php endif; ?> id="disable_user_otp_verify">
                                    <span class="slider-enable-disable"></span>
                                </label>
                                <small class="form-text text-muted"><?php echo e(__('Disable, means user must have to verify their OTP in order to access his/her dashboard.')); ?></small>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/halwanimadani/manfz/@core/resources/views/backend/general-settings/basic.blade.php ENDPATH**/ ?>