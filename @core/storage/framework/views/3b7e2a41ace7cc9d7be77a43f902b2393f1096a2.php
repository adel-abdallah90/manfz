        ...
        <div class="dashboard__bottom mt-5">
            <ul class="dashboard__bottom__list dashboard-list">
                ...
                <?php if(!empty(get_static_option('google_map_settings'))): ?>
                    <!--service zone set -->
                    <li class="dashboard__bottom__list__item <?php if(request()->is('seller/seller-zone')): ?> active <?php endif; ?>">
                        <a href="<?php echo e(route('seller.service.zone')); ?>"> <i class="las la-map"></i><?php echo e(__('Service Zone Settings')); ?> </a>
                    </li>
                <?php endif; ?>
...
</div><?php /**PATH /home/halwanimadani/manfz/@core/resources/views/frontend/user/seller/partials/sidebar-two.blade.php ENDPATH**/ ?>