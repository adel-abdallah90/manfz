                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="accordion-wrapper">
                                        <div id="accordion-payment">
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="kineticpay_pago_settings">
                                                    <h5 class="mb-0">
                                                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#kineticpay_settings_content" aria-expanded="false" >
                                                            <span class="page-title"> <?php echo e(__('kineticpay Settings')); ?></span>
                                                        </button>
                                                    </h5>
                                                </div>

                                                <div id="kineticpay_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">

                                                        <div class="form-group">
                                                            <label for="kineticpay_gateway"><strong><?php echo e(__('Enable/Disable Kineticpay')); ?></strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="kineticpay_gateway"  <?php if(!empty(get_static_option('kineticpay_gateway'))): ?> checked <?php endif; ?> >
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="kineticpay_test_mode"><strong><?php echo e(__('Enable Test Mode Kineticpay')); ?></strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="kineticpay_test_mode" <?php if(!empty(get_static_option('kineticpay_test_mode'))): ?> checked <?php endif; ?>>
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="kineticpay_preview_logo"><strong><?php echo e(__('Kineticpay Logo')); ?></strong></label>
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    <?php
                                                                        $marcadopago_img = get_attachment_image_by_id(get_static_option('kineticpay_preview_logo'),null,true);
                                                                        $marcadopago_image_btn_label = __('Upload Image');
                                                                    ?>
                                                                    <?php if(!empty($midtrans_img)): ?>
                                                                        <div class="attachment-preview">
                                                                ...
                                                                <input type="hidden" name="kineticpay_preview_logo" value="<?php echo e(get_static_option('kineticpay_preview_logo')); ?>">
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="<?php echo e(__('Select Image')); ?>" data-modaltitle="<?php echo e(__('Upload Image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                                                    <?php echo e(__($mollie_image_btn_label)); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="kineticpay_username"><?php echo e(__('Kineticpay Username')); ?></label>
                                                            <input type="text" name="kineticpay_username"  value="<?php echo e(get_static_option('kineticpay_username')); ?>" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/halwanimadani/manfz/@core/resources/views/backend/general-settings/payment-gateway.blade.php ENDPATH**/ ?>