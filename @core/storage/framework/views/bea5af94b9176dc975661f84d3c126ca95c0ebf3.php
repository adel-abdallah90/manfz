                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="dashboard-settings margin-top-40">
                                <h3 class="dashboards-title"> <?php echo e(__('Ticket Details')); ?> </h3>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="gig-chat-message-heading">
                                        <div class="header-wrap d-flex justify-content-between">
                                            <h5 class="header-title"><?php echo e(__('Support Ticket Details')); ?></h5>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/manfz/ssll/manfz.sa/@core/resources/views/backend/pages/ticket/ticket-details.blade.php ENDPATH**/ ?>