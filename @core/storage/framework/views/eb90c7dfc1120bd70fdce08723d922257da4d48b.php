            ...
            $(document).ready(async function() {
                ...
                $('.confirm-location .next').on('click', function() {
                    ...
                    if(check_user_address) {
                        Command: toastr["warning"]("<?php echo e(__('Please select your area!')); ?>", "<?php echo e(__('Aviso')); ?>");
                        toastr.options = {
                            "closeButton": true,
                            "debug": false,
                            "newestOnTop": false,
                ...
                $('.confirm-date-time .next').on('click',function(){
                    ...
                    if(date_string_format=='' || available_schedule==''){
                        Command: toastr["warning"]("<?php echo e(__('Please select date and schedule!')); ?>", "<?php echo e(__('Aviso')); ?>")
                        toastr.options = {
                            "closeButton": true,
                            "debug": false,
                            "newestOnTop": false,
                ...
                $('.confirm-information .next').on('click',function(){
                    ...
                    if(name=='' || email=='' || phone=='' || post_code=='' || address==''){
                        Command: toastr["warning"]("<?php echo e(__('Please fill all fields!')); ?>", "<?php echo e(__('Aviso')); ?>")
                        toastr.options = {
                            "closeButton": true,
                            "debug": false,
                            "newestOnTop": false,
...
//                  $seller_country = \App\Country::findOrFail($seller_city->country_id);
                ...
                <?php if(!empty($service_seller->latitude)): ?>
                    var seller_lat =  '<?php echo e($service_seller->latitude); ?>';
                    var seller_long = '<?php echo e($service_seller->longitude); ?>';
                <?php else: ?>
                    var seller_lat =  0;
                    var seller_long = 0;
                <?php endif; ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php $__env->stopSection(); ?><?php /**PATH /home/manfz/ssll/manfz.sa/@core/resources/views/frontend/pages/services/service-book-js.blade.php ENDPATH**/ ?>