...
} elseif ($_instance->childHasBeenRendered('Udpg6Ap')) {
    $componentId = $_instance->getRenderedChildComponentId('Udpg6Ap');
    $componentTag = $_instance->getRenderedChildComponentTagName('Udpg6Ap');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Udpg6Ap');
} else {
    $response = \Livewire\Livewire::mount('add-service', []);
    $html = $response->html();
    $_instance->logRenderedChild('Udpg6Ap', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/halwanimadani/manfz/@core/resources/views/frontend/user/seller/services/partials/add-service-two.blade.php ENDPATH**/ ?>