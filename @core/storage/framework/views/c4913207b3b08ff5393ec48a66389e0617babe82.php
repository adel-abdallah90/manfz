            ...
            <div class="signup-contents">
                ...
                <form class="signup-forms" method="post">
                    ...
                    <div class="text-success mt-2">
                      <a href="<?php echo e(route('user.login.set.phone.number')); ?>"><strong id="loginWithOtp"><?php echo e(__('Login with OTP')); ?></strong> </a>
                    </div>
                    <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/halwanimadani/manfz/@core/resources/views/frontend/user/login.blade.php ENDPATH**/ ?>