...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Subscription History')); ?>
                    ...
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <div class="left-content">
                                <h4 class="header-title"><?php echo e(__('Seller Subscription History')); ?>  </h4>
                                <p class="text-warning"><?php echo e(__('Seller earlier subscription history list.')); ?></p>
                            </div>
                        </div>
                        <div class="table-wrap table-responsive">
                            <table class="table table-default">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $subscription_history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/manfz/ssll/manfz.sa/@core/Modules/Subscription/Resources/views/backend/history.blade.php ENDPATH**/ ?>