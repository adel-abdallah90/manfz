                                    ...
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="custom-form">
                                            <div class="single-input">
                                                ...
                                                <?php if($service_details_for_book->is_service_online == 0): ?> service_wise_seller_country <?php endif; ?>"
                                                                    ...
                                                                    <div class="new_packageBook__addFeature__flex">
                                                                        <div class="new_packageBook__addFeature__contents">
                                                                            <div class="checkbox-inlines">
                                                                                <input class="check-input" type="checkbox" id="<?php echo e($additional->id); ?>" value="<?php echo e($additional->id); ?>">
                                                                                <label class="new_packageBook__addFeature__title" for="<?php echo e($additional->id); ?>"> <?php echo e($additional->additional_service_title); ?> </label>
                                                                            </div>
                                ...
                                <div class="btn-wrapper btn_flex justify-content-end mt-4">
                                    <?php if($service_details_for_book->is_service_online == 1): ?>
                                        <?php if(Auth::guard('web')->check()): ?>
                                            ...
                                            <?php if($service_details_for_book->is_service_online == 1): ?> d-none <?php endif; ?>" value="Previous"/>
                                            <input type="button" name="next" class="next stepForm_btn radius-5" value="Next"/>
                                        <?php else: ?>
                                            <div class="btn-wrapper">
                                                <a class="action-button text-white" href="<?php echo e(route('user.login')); ?>?return=<?php echo e(request()->path()); ?>"><?php echo e(__('Sign In')); ?></a>
                            ...
                            <fieldset class="padding-top-50 edit_style_payment_option">
                                ...
                                <div class="btn-wrapper btn_flex justify-content-end mt-4">
                                    <?php if($service_details_for_book->is_service_online == 1): ?>
                                        <?php if(Auth::guard('web')->check()): ?>
                                            <input type="button" name="stepPrevious" class="stepPrevious stepForm_btn__previous radius-5" value="Previous"/>
                                            <input type="submit" class="stepForm_btn radius-5" value="<?php echo e(get_static_option('service_order_confirm_title') ?? __('Pay & Confirm Your Order')); ?>">
                                        <?php else: ?>
                                                ...
                                                <ul class="summery_list border_top list_none <?php if($service_details_for_book->is_service_online == 1): ?> d-none <?php endif; ?>">
                                                    <?php $__currentLoopData = $service_includes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $include): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="list include_service_id_<?php echo e($include->id); ?> include_service_list">
                                                            ...
                                                            <span class="value_count room-count"><?php echo e(amount_with_currency_symbol($include->include_service_price)); ?></span>
                                                            <?php endif; ?>
                                                        </li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </ul>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/manfz/ssll/manfz.sa/@core/resources/views/frontend/pages/services/partials/service-book-two.blade.php ENDPATH**/ ?>