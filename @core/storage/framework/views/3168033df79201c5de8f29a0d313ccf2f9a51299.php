            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <div class="left-content">
                                <h4 class="header-title"><?php echo e(__('Email from the seller or buyer regarding account deletion')); ?> </h4>
                                <p class="mb-3 text-info"><?php echo e(__('If a user deletes their account, send a request through email to the administrator')); ?></p>
                            </div>
                        </div>
                        <div class="table-wrap table-responsive">
                            <form action="<?php echo e(route('admin.user.account.delete.request.update')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="form-group">
                                    <label for="user_permanently_delete_account"><?php echo e(__('Email Message')); ?></label>
                                    <textarea class="form-control" name="user_permanently_delete_account" id="user_permanently_delete_account" cols="30" rows="5">
                                        <?php echo e(get_static_option('user_permanently_delete_account') ?? ''); ?></textarea>
                                </div>
                                <div class="form-group">
                                    <input type="submit" value="Update" class="btn btn-primary">
                                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/manfz/ssll/manfz.sa/@core/resources/views/backend/pages/register-settings/user-register-settings.blade.php ENDPATH**/ ?>