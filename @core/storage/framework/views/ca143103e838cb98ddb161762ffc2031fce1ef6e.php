                                            ...
                                            <div class="dashboard_recentOrder__item__flex">
                                                <div class="dashboard_recentOrder__item__service">
                                                    ...
                                                    <div class="dashboard_recentOrder__item__service__contents">
                                                        <a href="<?php echo e(route('seller.order.details', $order->id)); ?>" class="dashboard_recentOrder__item__service__id">
                                                            <span><?php echo e(__('Order ID:')); ?></span> <?php echo e($order->id); ?></a>
                                                        <h4 class="dashboard_recentOrder__item__service__title mt-1">
                                                            <?php if(!empty($order->job_post_id)): ?>
                                                             ...
                                                             <?php else: ?>
                                                                <?php if(!is_null(optional($order->service)->slug)): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/manfz/ssll/manfz.sa/@core/resources/views/frontend/user/seller/dashboard/partials/dashboard-two.blade.php ENDPATH**/ ?>