              ...
              <div class="chat_wrapper__details__header__thumb">
                  <a href="javascript:void(0)" class="img-text">
                      <h3 class="panel-title">
                          ...
                          <span class="img-text">
                            <img class="user-image-avater" src="<?php echo e(asset('assets/frontend/img/static/user_profile.png')); ?>" alt="img">
                        </span>
                      </h3>
                  </a>
  ...
  </div><?php /**PATH /home/manfz/ssll/manfz.sa/@core/Modules/LiveChat/Resources/views/frontend/seller/partials/chat-box-two.blade.php ENDPATH**/ ?>