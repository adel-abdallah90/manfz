                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['service-list'])): ?>
                        <li
                            ...
                            <ul class="collapse">
                               ...
                               <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('order-create-setting')): ?>
                                    <li class="<?php echo e(active_menu('admin-home/services/load-more-category-settings')); ?>"><a
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('order-create-setting')): ?>
                                   ...
                                   <li class="<?php echo e(active_menu('admin-home/services/zones-settings')); ?>"><a  href="<?php echo e(route('admin.service.zone.settings')); ?>"><?php echo e(__('Google Map Settings')); ?></a></li>
                                <?php endif; ?>
...
<?php /**PATH /home/halwanimadani/manfz/@core/resources/views/backend/partials/sidebar.blade.php ENDPATH**/ ?>