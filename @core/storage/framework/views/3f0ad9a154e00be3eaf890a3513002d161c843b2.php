                                    ...
                                    <div class="tag-list">
                                        ...
                                        <ul>
                                            <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <li>
                                                    <?php if($tag->tag_name && json_decode($tag->tag_name)): ?>
                                                        <?php $__currentLoopData = json_decode($tag->tag_name); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            ?>
                                                            <?php if($tag_name): ?>
                                                                <a href="<?php echo e(route('frontend.blog.tags', $slug)); ?>"><?php echo e($tag_name); ?></a>
                                                            <?php endif; ?>
                                       ...
                                       <?php if(Auth::guard('web')->check()): ?>
                                        ...
                                        <?php else: ?>
                                           <?php if(empty(get_static_option('disable_user_otp_verify'))): ?>
                                                <a class="cmn-btn btn-outline-1" href="<?php echo e(route('user.login').'?return='.request()->path()); ?>"><?php echo e(__('Sign in for comment')); ?></a>
                                            <?php else: ?>
                                               <a class="btn btn-sm btn-success text-white" data-bs-toggle="modal" data-bs-target="#commentModal"><?php echo e(__('Sign in for comment')); ?></a>
                                           <?php endif; ?>
                                        <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/manfz/ssll/manfz.sa/@core/resources/views/frontend/pages/blog/blog-single.blade.php ENDPATH**/ ?>